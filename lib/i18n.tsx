...
export const DICT: Record<string, Entry> = {
  ...
  "shop.brandsNo": { en: "03" },
  "shop.brandsLabel": { en: "Brands We Carry" },
  ...
  "services.h2": { en: "Professional Bicycle Service" },
  "services.lede": {
    en: "Straightforward tune-ups and gear service, done by hand — call ahead or just walk in.",
  },
  "services.book": { en: "Book by Call" },
  "services.otherNote": { en: "Something else" },
  "services.otherTitle": { en: "Other Repairs" },
  "services.quote": {
    en: "Punctures, part replacements, custom builds — tell us what's wrong and we'll quote it straight.",
  },
  "services.ask": { en: "Ask for a Quote" },
