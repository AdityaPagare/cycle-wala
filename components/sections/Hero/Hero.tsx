...
/* Placeholder counts — replace with real shop numbers before launch. */
const STATS_LEFT = [
  { n: 500, suffix: "+", key: "stat.projects", icon: "/images/icons/projects.png" },
  { n: 5, suffix: "+", key: "stat.years", icon: "/images/icons/years.png" },
];
const STATS_RIGHT = [
  { n: 8, suffix: "+", key: "stat.countries", icon: "/images/icons/countries.png" },
