...
/* A small bicycle glyph — replaces the two-letter monogram fallback so the
   orbit reads as bicycles, not abbreviation tags. Recolored per-category via
   `color` (same field the monogram used to use). */
function BikeIcon({ color }: { color?: string }) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">
      <g fill="none" stroke={color ?? "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
